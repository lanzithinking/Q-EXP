#!/usr/bin/env python
"""
Class definition of data-misfit for linear inverse problem of torso CT.
-------------------------------------------------------------------------
Created May 15, 2023 for project of q-exponential process prior (Q-EXP)
"""
...
class misfit(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.data_set = kwargs.pop('data_set','torso')
        # get observations
        self.proj, self.obs, self.nzvar, self.size, self.truth = self.get_obs(**kwargs)
    
    def _gen_torso_CT(self):
        """
        Generate torso CT observations stored at https://drive.google.com/drive/folders/1VvL3U3o4V4-itrAo8gUBwatLCyGvEjFT?usp=sharing
        """
    ...
    def observe(self):
        ...
        """
        projection, angles, distances, truth, observation = self._gen_torso_CT()
...
if __name__ == '__main__':
    ...
    # plt.show()
    # plot reconstruction
    projection, angles, distances, truth, observation = msft._gen_torso_CT()
