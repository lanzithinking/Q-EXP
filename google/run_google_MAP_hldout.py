...
def main(seed=2022):
    ...
    prior_params={'prior_option':args.mdls[args.mdl_NO],
                  ...
                  'KL_trunc':100,
                  'space':'fun',
                  'sigma2':100 if args.mdls[args.mdl_NO]=='gp' else 10,
                  's':1,
    ...
    # save
    filename='Google_'+str(ts.misfit.size)+'days_MAP_dim'+str(len(map_f))+'_'+prior_params['prior_option']+'_'+prior_params['ker_opt']+'_'+ctime+'.pckl'
