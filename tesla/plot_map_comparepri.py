...
# obtain estimates
folder = './MAP'
if os.path.exists(os.path.join(folder,'Tesla_'+str(msft.size)+'days_map_summary.pckl')):
    f=open(os.path.join(folder,'Tesla_'+str(msft.size)+'days_map_summary.pckl'),'rb')
    ...
    errs=np.stack(errs)
    # save
    f=open(os.path.join(folder,'Tesla_'+str(msft.size)+'days_map_summary.pckl'),'wb')
...
# save plot
# fig.tight_layout()
plt.savefig(os.path.join(folder,'Tesla_'+str(msft.size)+'days_maps_comparepri.png'),bbox_inches='tight')
# plt.show()
...
# save plot
# fig.tight_layout()
plt.savefig(os.path.join(folder,'Tesla_'+str(msft.size)+'days_errs_comparepri.png'),bbox_inches='tight')
# plt.show()