...
if __name__ == '__main__':
    ...
    fig=msft.plot_data(images={0:msft.truth,1:msft.obs.reshape((angles.size,distances.size),order='F'),2:rcstr_LSE}, titles={0:'Truth',1:'Observation',2:'LSE-reconstruction'},
