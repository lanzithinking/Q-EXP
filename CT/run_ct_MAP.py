"""
Main function to obtain maximum a posterior (MAP) for linear inverse problem of Shepp-Logan head phantom
----------------------
Shiwei Lan @ ASU, 2022
"""
...
def main(seed=2022):
    ...
    parser.add_argument('NCG', nargs='?', type=int, default=1) # choose to optimize with Newton conjugate gradient method
