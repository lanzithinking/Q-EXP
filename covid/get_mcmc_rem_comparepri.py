...
rem_m.to_csv(os.path.join(folder,'Covid_'+ts.misfit.truth_name+'-REM-mean.csv'),columns=mdl_names[:num_mdls])
rem_s.to_csv(os.path.join(folder,'Covid_'+ts.misfit.truth_name+'-REM-std.csv'),columns=mdl_names[:num_mdls])