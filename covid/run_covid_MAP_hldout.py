...
def main(seed=2022):
    ...
    size = 229 if args.opt==0 else 100 if args.opt==1 else 50
    ...
    filename='Covid_'+ts.misfit.truth_name+'_MAP_dim'+str(len(MAP))+'_'+prior_params['prior_option']+'_'+prior_params['ker_opt']+'_'+ctime+'.pckl'
